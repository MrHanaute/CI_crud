...
class Dashboard extends CI_Controller {
	...
	public function Index()
	{
		...
		$contatos = $this->Usuario->GetAll('nome');
		// Passa os contatos para o array que será enviado à home
		$dados['contatos'] =$this->Usuario->Formatar($contatos);
	...
	public function Salvar(){
		...
		if($validacao){
			...
			$status = $this->Usuario->Inserir($contato);
	...
	public function Editar(){
		...
		$dados['contato'] = $this->Usuario->GetById($id);
	...
	public function Atualizar(){
		...
		if($validacao){
			...
			$status = $this->Usuario->Atualizar($contato['id'],$contato);
			// Checa o status da operação gravando a mensagem na seção
			if(!$status){
				$dados['contato'] = $this->Usuario->GetById($contato['id']);
	...
	public function Excluir(){
		...
		$status = $this->Usuario->Excluir($id);
		// Checa o status da operação gravando a mensagem na seção
		if($status){
